...
export default function Body(props) {
  ...
  const patients = [
    {name: 'robin', reports: [{title: 'Report 1', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',}]},
    {name: 'ww', reports: [{title: 'Report 1', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',},{title: 'Report 2', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',}]},
    {name: 'superman', reports: [{title: 'Report 1', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',},{title: 'Report 2', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',},{title: 'Report 3', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',}]},
    {name: 'alfred', reports: [{title: 'Report 1', iaValutation: 'Not Evaluated', doctorValutation: 'Not Evaluated', description: 'Blablabla1',}]},
  ];
        ...
        <Grid item xs={12} sm={12} md={4}>
            <Grid item xs={12} sm={12} md={12} component={Paper} elevation={6} square >
                <div className={classes.paper}>
                    ...
                    <br/>
                    <Grid item xs={12} sm={12} md={12}>                            
                        {modifyDataDiv(props, classes, expanded, handleChange)}
                        <br/>
                    </Grid>
                </div>
            </Grid >
            {chatDiv(props, classes, names, chats, expanded, handleChange, personName)}
        </Grid>
        <Grid item xs={1} md={1}></Grid>
        <Grid item xs={12} sm={12} md={5}>
            {reportDiv(props, classes, reports, patients, expanded, handleChange, personName)}
            <br/><br/><br/><br/>
            <Grid item xs={12} sm={12} md={12} component={Paper} elevation={6} square>
                <BottomNavigation
                  value={value}
...
function modifyDataDiv(props, classes, expanded, handleChange) {
    if(props.status==='doctor' || props.status==='patient' ){
        return(
...
function reportDiv(props, classes, reports, patients, expanded, handleChange, personName){
    ...
    if(props.status==='patient'){
                ...
                <div className={classes.paper}>
                    ...
                    <Typography variant="h6">
                        <FormControl className={classes.formControl}>
                            ...
                            id="combo-box-demo"
                            options={patients}
                            getOptionLabel={patients => patients.name}
                            style={{ width: 280 }}
                            renderInput={params => (
                    ...
                    <br/>
                    <Typography>
                        &nbsp;<Button variant="contained" color="primary" alignItems="center" onClick={() => props.getReports(personName)}>Select</Button>
                    </Typography>
                    <br/>
                    {
                    patients[2].reports.map((v)=>
                        <ExpansionPanel className={classes.expands} expanded={expanded === 'panel'+v.title} onChange={handleChange('panel'+v.title)}>
                            <ExpansionPanelSummary
                            expandIcon={<ExpandMoreIcon />}
                            aria-controls="panelbh-content"
                                    ...
                                    <Grid item xs={4} md={4}>
                                        <Typography variant="h6">
                                            <Grid item xs={12}>
                                                ...
                                                fullWidth
                                                id="doctorValutation"
                                                label="Insert your Valutation"
                                                name="doctorValutation"
                                                onChange={props.onChange}
                                                />
                                            </Grid>
                                            <br/>
                                            <Button key={v.name} variant="contained" color="primary" onClick={() => props.insertDoctorValutation(v.name)}>Insert</Button>
                                        </Typography>
                                    </Grid>
                                </Grid>
                            </ExpansionPanelDetails>
        ...
        return(
            <Grid item xs={12} sm={12} md={12}>
                <div className={classes.paper}>
                    <Button variant="contained" color="primary" onClick={() => props.follow()}>Follow</Button>
                </div>
            </Grid>
        )
    }
...
function chatDiv(props, classes, names, chats, expanded, handleChange, personName){
